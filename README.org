...
(defmacro html-tempo-paired-tag-single-line (var)
  (list 'tempo-define-template var
        (list 'quote (list var "> " '> 'p (concat " </" var ">") '>)) var (concat "insert html " var " tag") (list 'quote 'html-tempo-tags)))

(seq-do (lambda (x)
          "expand macro"
          (eval (list 'html-tempo-paired-tag-single-line x)))
        '("li" "th" "td" "caption" "p" "b" "bdi" "bdo" "title" "button"
          "cite" "data" "del" "summary" "dfn" "em" "figcaption"
          "h1" "h2" "h3" "h4" "h5" "h6" "i" "iframe" "kbd" "label"
          "legend" "mark" "meter" "a" "object" "option" "progress" "q"
          "s" "samp" "small" "span" "strong" "sub" "summary" "sup" "time"))

(defmacro html-tempo-paired-tag-ml (var)
  (list 'tempo-define-template var
        (list 'quote (list var ">" 'n> 'p 'n> (concat "</" var ">") '>)) var (concat "insert html " var " tag") (list 'quote 'html-tempo-tags)))

(seq-do (lambda (x)
          "expand macro"
          (eval (list 'html-tempo-paired-tag-ml x)))
        '("table" "address" "ol" "ul" "thead" "tbody" "tfoot" "map" "article"
          "tr" "colgroup" "aside" "body" "head" "blockquote" "canvas" "code"
          "datalist" "dl" "details" "dialogue" "div" "fieldset" "figure"
          "footer" "form" "header" "main" "script" "noscript" "nav" "optgroup"
          "pre" "section" "select" "audio" "style" "svg" "template"
          "textarea" "video"))
